...
<template>
    ...
    >
        <HeadlessDisclosureButton
            class="dark:hover:bg-soft-silk/5 hover:bg-anthracite/20 dark:text-soft-silk/80 text-obsidian flex h-fit
                w-fit cursor-pointer items-center gap-2 rounded-lg bg-transparent px-2 py-2 transition-colors
