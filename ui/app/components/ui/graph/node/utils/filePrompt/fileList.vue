...
<template>
    <div v-if="props.files.length" class="purple-scrollbar grow overflow-y-auto">
        <ul
            class="nodrag nowheel grid gap-2"
            :class="{
                'grid-cols-[repeat(auto-fill,minmax(12rem,1fr))]': props.files.length > 1,
                'h-full grid-cols-1': props.files.length === 1,
            }"
        >
            <li
            ...
            >
                ...
                >
                    ...
                    <button
                        ...
                        :class="{
                            'absolute top-2 right-2': props.files.length === 1,
                        }"
                        title="Delete file"
