    ...
    >
        <div class="bg-[#1A1A1A]/70 p-8 backdrop-blur-2xl md:p-12">
            ...
            <form class="flex flex-col space-y-6" @submit.prevent="verify">
                <div class="flex justify-center">
                    <input
                        ...
                        class="text-soft-silk placeholder-stone-gray/30 focus:ring-ember-glow/50
                            w-48 rounded-xl border border-white/5 bg-[#222222] px-4 py-3 text-center
                            text-2xl font-bold tracking-[0.5em] transition-all duration-200
                ...
                <button
                    type="submit"
                    class="bg-soft-silk text-obsidian hover:bg-soft-silk/80 flex w-full items-center
                        justify-center rounded-full py-3.5 text-sm font-bold transition-all
                        duration-200 hover:cursor-pointer focus:ring-2 focus:ring-white/50
                        focus:ring-offset-2 focus:ring-offset-[#1A1A1A] focus:outline-none"
                >
                    Verify Account
                </button>
            </form>
