...
- **`generate_image` Tool:**
    ...
    *   **Response:** The tool will return a success message with the URL of the generated image. **You MUST display the image in your final response using standard Markdown syntax: `![Image Description](url)`.**
"""
